...
router.get('/:model', readCategories);
router.get('/:model/:_id', readCategories);
router.post('/:model', createCategories);
router.delete('/:model/:_id', deleteCategories);
router.put('/:model/:_id', updateCategories);
